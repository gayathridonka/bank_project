CREATE OR REPLACE PACKAGE BODY HCL_BANK IS
...
PROCEDURE PROC_DEL_CUST(P_BANK_CUST_ID BANK_CUST.CUST_ID%TYPE) IS
BEGIN
 DELETE BANK_CUST WHERE BANK_CUST.CUST_ID=P_BANK_CUST_ID;
 --COMMIT;
END PROC_DEL_CUST;

PROCEDURE PROC_DEL_CUST(P_CUST_FIRST_NAME BANK_CUST.CUST_FIRST_NAME%TYPE) IS
BEGIN
